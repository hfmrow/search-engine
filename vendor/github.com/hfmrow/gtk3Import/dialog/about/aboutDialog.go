...
import (
	...
	pm "github.com/hfmrow/gtk3Import/pango"
...
func (infos *AboutInfos) Show() {
	if infos.ready && !infos.initialised {
		...
		p.SetImage(aboutDlgControlObj.AboutTopImage, infos.imageTop)
		p.SetButtonImage(aboutDlgControlObj.AboutboxButtonOk, infos.imageOkButton)
